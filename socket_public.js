...
var screenshotButtonHook = function () {
    ...
    var text = ' <div class="item active"> <div class="panel panel-primary"> <div class="panel-heading"> <h4 class="panel-title">' + time + '</h4> </div> <div class="panel-screenview panel-body"><canvas class="screenshot"></canvas></div><div class="panel-footer"> <button type="button" class="download-link btn btn-default">Download<span class="glyphicon glyphicon-download"></span></button><button type="button" class="emailBtn btn btn-default">Email <span class="glyphicon glyphicon-envelope"></span></button></div></div> </div>';
...
var emailButtonHook = function () {
    ...
    payload = {email: decodeURI($('#email-id')[0].value), img_array: imgarray};
